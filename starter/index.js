...
// calculate the total number of months in the finances dataset.
...
function calculateAverageChange(finances) {
  ...
  const averageChange = total / numberOfMonths;
  return Math.round(averageChange * 100) / 100; // Rounded to the nearest hundreth of a decimal.
}
